...
namespace PointePayApp.Common
{
    public class Utilities
    {
        ...
        public static List<MenuItems> GetMenuItems(MenuCode MenuCode)
        {
            ...
            MenuItemsList.Add(new MenuItems { Text = "Product Management", code = MenuCode.ProdMgnt.ToString(), redirecturl = "/Views/Product/ProductListPage.xaml", iconsrc = "/Assets/MenuIcon/view-product.png", count = "0", selectedBgColor = _ProdMgntBackground, selectedTextColor = _ProdMgntForeground });
