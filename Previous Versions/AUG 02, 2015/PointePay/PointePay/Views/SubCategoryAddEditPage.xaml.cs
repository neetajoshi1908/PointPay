...
namespace PointePay.Views
{
    ...
    {
        public List<SubCategoryViewModel> ListCategoryData { get; set; }
        ...
        void wc_UploadCategoryCompleted(object sender, UploadStringCompletedEventArgs e)
        {
            try
            {
                ...
                {
                    ListCategoryData = new List<SubCategoryViewModel>();
                ...
                else
                {
                    ...
                    {
                        ListCategoryData = new List<SubCategoryViewModel>();
                        ListCategoryData.Add(new SubCategoryViewModel { categoryId = "0", categoryCode = "-- Select State --" });
                        foreach (var itm in rootObject.response.data)
                        {
                            ListCategoryData.Add(new SubCategoryViewModel { categoryId = itm.categoryId, categoryCode = itm.categoryCode });
                        };
                        this.listPickerCategory.ItemsSource = ListCategoryData;
